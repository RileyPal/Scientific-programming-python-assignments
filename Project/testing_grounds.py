...
def thrust_function(air_density, velocity, intake_area):
    # Assuming methane is fuel being used with and energy density of 50 MJ/kg of fuel 70% is converted to thrust
    ...
    return (((((0.2 * air_density * velocity * intake_area)/4) * 50000000 * 0.7) * 300) / 9.81)
